...
class TestAnalyticsRecording:
    ...
    def temp_analytics_dir(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with mock.patch("analytics.DATA_DIR", tmpdir), \
    ...
    async def test_record_request_increments_count(self, temp_analytics_dir):
        ...
        from analytics import record_request, _load_counts, COUNTS_FILE
    ...
    async def test_record_request_search_and_fetch(self, temp_analytics_dir):
        ...
        from analytics import record_request, COUNTS_FILE
    ...
    @pytest.mark.asyncio
    async def test_record_request_unknown_tool_defaults_to_search(self, temp_analytics_dir):
...
class TestAnalyticsDataFrame:
    ...
    def test_last_n_days_unknown_tool_defaults_to_search(self, temp_analytics_with_data):
